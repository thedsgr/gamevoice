...
import handleButtonInteraction from '../services/buttonHandler.js';

const cooldownTime = 10; // Tempo de cooldown em segundos

export default async function interactionCreate(interaction: Interaction, client: ExtendedClient) {
