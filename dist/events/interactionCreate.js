...
import { MessageFlags, Client, Collection, GatewayIntentBits, ApplicationCommandType, } from "discord.js";
import { db } from '../utils/db.js';
const cooldownTime = 5000;
setTimeout(() => {
    console.log('Cooldown finalizado');
}, cooldownTime);
export default async function handleInteractionCreate(interaction, client) {
